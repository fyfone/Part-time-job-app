...
public class ImageGridActivity extends Activity {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(ImageGridActivity.this, "最多选择3张图片",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tbvTitle = (TitleBarView) findViewById(R.id.image_grid_titlebar);
		tbvTitle.setClickEnterButtonListener(new OnClickEnterButtonListener() {
