...
public class InviteRecordAdapter extends BaseAdapter {
	...
	private List<InvieRecordTwo> dataSet;
	...
	public void getDate(Context context, List<InvieRecordTwo> dataSet) {
	...
	public View getView(final int location, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater
					.inflate(R.layout.listview_invite_item, null);
		...
		holder.sqjl_item_title
				.setText(dataSet.get(location).JE + "  ("
						+ dataSet.get(location).S + "/"
						+ dataSet.get(location).U + ")");
		holder.sqjl_item_cn.setText(dataSet.get(location).CE);
		holder.sqjl_item_unit.setText("(" + dataSet.get(location).IST + ")");
		holder.sqjl_item_loca.setText(dataSet.get(location).IE);
	...
	private class ViewHolder {
		private TextView sqjl_item_time, sqjl_item_title, sqjl_item_cn,
				sqjl_item_salary, sqjl_item_unit, sqjl_item_loca;
