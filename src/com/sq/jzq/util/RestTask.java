...
public class RestTask extends AsyncTask<Void, Integer, Object> {
    ...
    public void setFormBody(List<NameValuePair> formData) {
        ...
        iFormBodyLength = mFormBody.length();
    }
    
    public void setMultipartBody(List<NameValuePair> formData) {
        if (formData == null) {
            mFormBody = null;
            return;
        }

        mFormBody = URLEncoder.encode(formData.get(0).getValue());
		iFormBodyLength = mFormBody.length();
    }
    ...
    private void writeMultipart(String boundary, String charset, OutputStream output, boolean writeContent) throws IOException {
        ...
        try {
            ...
            if (mFormBody != null) {
                ...
                writer.write("\r\n");
                writer.write("Content-Disposition: form-data; name=\"" + Globals.WS_POST_KEY + "\"");
//                writer.write("\r\n");
...
//                }
                ...
                mConnection.setFixedLengthStreamingMode(iFormBodyLength);
            ...
            if (status >= 300) {
                ...
                Log.i(Globals.LOG_TAG, "Status:" + status + " ,Msg:" + message);
    ...
    protected void onPostExecute(Object result) {
        if (mResponseCallback != null && mResponseCallback.get() != null) {
            if (result instanceof String) {
            	Log.i(Globals.LOG_TAG, "Result:<" + (String) result + ">");
