...
public class ComapanyReceiveCollectiondapter extends BaseAdapter {

	private List<ReceiveCollection> dataSet;
	private LayoutInflater mInflater;
	private Context context;

	public ComapanyReceiveCollectiondapter() {

	}

	public void getDate(Context context, List<ReceiveCollection> dataSet) {
